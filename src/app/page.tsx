        ...
        <div className="h-full flex flex-col justify-center items-start gap-4 xl:gap-6 p-6 xl:p-12">
          ...
          <div className="relative">
            <div className="w-64 xl:w-106 border-dashed-wide flex items-center justify-start pl-2">
              <Link href="/brainwriting" className="mb-6 text-sm xl:text-4xl font-normal text-primary hover:text-primary-hover hover:bg-accent px-2 py-1 rounded transition-all duration-200 flex items-center gap-2">
                ブレインライティング
          ...
          <div className="relative">
            <div className="w-52 xl:w-68 border-dashed-wide flex items-center justify-start pl-2">
              <Link href="/mandala" className="mb-6 text-sm xl:text-4xl font-normal text-primary hover:text-primary-hover hover:bg-accent px-2 py-1 rounded transition-all duration-200 flex items-center gap-2">
                マンダラート
                <svg className="w-3 h-3 xl:w-6 xl:h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                </svg>
          ...
          <div className="relative">
            <div className="w-72 xl:w-132 border-dashed-wide flex items-center justify-start pl-2">
              <Link href="/osborn" className="mb-6 text-xs xl:text-4xl font-normal text-primary hover:text-primary-hover hover:bg-accent px-2 py-1 rounded transition-all duration-200 flex items-center gap-2">
                オズボーンのチェックリスト
                <svg className="w-3 h-3 xl:w-6 xl:h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                </svg>
          ...
          <div className="relative">
            <div className="w-52 xl:w-74 border-dashed-wide flex items-center justify-start pl-2">
              <Link href="/ideas" className="mb-6 text-sm xl:text-4xl font-normal text-primary hover:text-primary-hover hover:bg-accent px-2 py-1 rounded transition-all duration-200 flex items-center gap-2">
                アイデア一覧
                <svg className="w-3 h-3 xl:w-6 xl:h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                </svg>
