          ...
          >
            ...
            {activeTab === "xpost" && (
              <div className="space-y-6">
                <section>
                  <h3 className="mb-3 text-lg font-semibold text-foreground">X投稿版とは？</h3>
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Q. 途中で保存できますか？</p>
                      <p className="text-muted">A. 入力内容は自動保存されます。</p>
                    </div>
                  </div>
                </section>
              </div>
            ...
            {activeTab === "team" && (
              <div className="space-y-6">
                <section>
                  <h3 className="mb-3 text-lg font-semibold text-foreground">チーム利用版とは？</h3>
                  <p className="leading-relaxed text-muted">
