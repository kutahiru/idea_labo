          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  <p className="font-semibold text-gray-800">Q. 誰でもアイデアを追加できますか？</p>
        ...
        {activeTab === "team" && (
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  <p className="font-semibold text-gray-800">Q. 何人で実施するのが良いですか？</p>
                  <p className="text-gray-700">
                    A. 3〜6人程度が最適です。それ以上になると時間がかかりすぎる可能性があります。
                  </p>
                </div>
                <div>
