...
export default function Footer() {
  ...
  return (
    <footer className="border-primary/20 border-t bg-surface py-4">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
          {/* コピーライト */}
          <div className="text-center">
            <p className="text-xs text-muted-foreground">&copy; {currentYear} アイデア研究所</p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs md:gap-6 md:text-sm">
            <Link
              href="/privacy-policy"
              className="hover:text-primary text-muted transition-colors hover:underline"
            >
              プライバシーポリシー
            </Link>
            <Link
